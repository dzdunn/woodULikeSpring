...
//        return sessionNavigation.getLastRequest().startsWith("redirect:") ? sessionNavigation.getLastRequest() : "redirect:" + sessionNavigation.getLastRequest();
//    }
//
...
//        return Arrays.asList(allowedViews).contains(sessionNavigation.getLastRequest());
//    }
//
